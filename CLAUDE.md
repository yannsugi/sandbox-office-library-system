...
## 🗄 DB (Postgres / Diesel) - Minimal tables
...
## 🏗 Workspace layout (layer × context sub-crates)
...
- controller_utils/                # shared transaction helper
- di_service/
- app/

frontend/
- src/
  - components/                    # shared components (PageHeader)
  - lib/                           # API client (axios)
  - pages/                         # page components (Books, Divisions, Users)
  - App.tsx                        # main app with routing
  - main.tsx                       # entry point

Use lib.rs based crates for backend.
...
## 🎮 Controller (transaction boundary here only)
Controllers:
...
Implemented compileable code for contexts {division, user, book}:
1) ✅ Domain crates (VO/entity/collection) with cross-id references allowed
2) ✅ Presenter Jdto crates
3) ✅ db_domain crates with schema.rs + models.rs (auto-generated by diesel.toml)
4) ✅ repository traits (organized as CRUD: Create/Read/Update/Delete)
5) ✅ repository_impl Diesel implementations
6) ✅ feature + usecase implementations using where clauses
7) ✅ controller endpoints with shared with_tx helper (in controller_utils)
8) ✅ app routing + main with CORS support
9) ✅ React + TypeScript frontend with:
   - Books/Divisions/Users pages
   - TanStack Query for API state management
   - Tailwind CSS for styling
   - Shared PageHeader component

All implementation follows the architecture rules and patterns defined above.
